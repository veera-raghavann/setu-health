...
export function decide(s:IntakeSession,value:string,inputMode:string){const d=processPatientInput(s,value,inputMode as any);s.state=d.state;s.nextAction=d.nextAction;return s}